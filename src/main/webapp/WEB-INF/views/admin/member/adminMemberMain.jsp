...
function search_member(search_period){
    ...
    /* 
    <form method="get" action="/bookshop01/admin/member/adminMemberMain.do">
...
function fn_enable_detail_search(r_search){
	...
	var frm_delivery_list=document.frm_delivery_list;  // 회원 조회 전체 폼
